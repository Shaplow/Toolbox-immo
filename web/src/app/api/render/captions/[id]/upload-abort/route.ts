/**
 * POST /api/render/captions/[id]/upload-abort
 *
 * Annule un upload multipart R2 en cours pour un CaptionJob et libère le
 * stockage partiel. À appeler si le client abandonne ou si l'upload échoue.
 *
...
export async function POST(
  ...
  try {
    ...
    console.error(`[captions/upload-abort] abortMultipartUpload failed key=${job.inputKey} uploadId=${uploadId}:`, err);
