...
export function ValidationActions({ token, allowsRevision }: Props) {
  ...
  return (
    <section className="bg-white rounded-xl border border-border p-5 shadow-sm space-y-4">
      <h3 className="text-sm font-semibold text-foreground">Votre décision</h3>
      ...
      <button
        ...
        className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-success-600 text-white font-medium hover:bg-success-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
        <Check size={16} />
        ...
        <>
          {!showRejectForm ? (
            <button
              ...
              disabled={submitting !== null}
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-warning-200 bg-warning-50 text-warning-700 font-medium hover:bg-warning-100 disabled:opacity-50 transition-colors"
            >
              <MessageSquare size={16} />
              Demander des modifications
            </button>
          ) : (
            <div className="space-y-3 border border-warning-200 rounded-lg p-3 bg-warning-50/50">
              <label className="block">
                ...
                <textarea
                  ...
                  className="mt-1 w-full min-h-[100px] px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent"
                  maxLength={2000}
                />
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={submitting !== null}
                  className="flex-1 px-4 py-2 rounded-lg border border-border text-sm text-foreground hover:bg-muted disabled:opacity-50"
                >
                  Annuler
                </button>
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-warning-600 text-white text-sm font-medium hover:bg-warning-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
      ...
      {!showCancelConfirm ? (
        <button
          ...
          disabled={submitting !== null}
          className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-border text-muted-foreground text-sm hover:bg-muted disabled:opacity-50"
        >
          <X size={16} />
          {allowsRevision
        ...
        <div className="space-y-3 border border-red-200 rounded-lg p-3 bg-red-50/50">
          ...
          <label className="block">
            ...
            <textarea
              ...
              className="mt-1 w-full min-h-[60px] px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-400"
              maxLength={2000}
            />
          </label>
          <div className="flex gap-2">
