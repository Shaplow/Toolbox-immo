...
export default async function DataLibraryDetailPage({ params }: Props) {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <Link href="/admin/libraries/data" className="flex items-center gap-1 text-xs text-gray-400 hover:text-gray-600 mb-6">
        <ChevronLeft size={14} /> Bibliothèques de données
      </Link>
