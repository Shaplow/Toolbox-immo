  ...
  return (
    <div ref={ref} className="relative" data-menu-open={open ? "true" : undefined}>
      <button
        ...
        className="flex items-center justify-center w-8 h-7 rounded-lg border border-gray-200 text-muted-foreground hover:text-foreground hover:border-gray-300 hover:bg-gray-50 transition-colors"
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 w-44 bg-white border border-gray-200 rounded-xl shadow-lg z-20 py-1 text-sm">
          <button
            ...
            className="w-full flex items-center gap-2.5 px-3 py-2 text-left text-muted-foreground hover:bg-gray-50 hover:text-foreground disabled:opacity-50 transition-colors"
          >
            <Download size={13} />
            ...
            <div className="px-3 py-2 space-y-1.5">
              ...
              <div className="flex gap-1.5">
                ...
                <button
                  ...
                  className="flex-1 text-xs bg-gray-100 hover:bg-gray-200 text-muted-foreground py-1 rounded-lg transition-colors"
                >
                  Annuler
                </button>
              </div>
