...
export function TemplatePreviewFrame({
  ...
  return (
    <div className="flex h-full w-full min-h-0 flex-col overflow-hidden rounded-xl border border-border bg-neutral-950">
      <div ref={containerRef} className="flex min-h-0 flex-1 items-center justify-center overflow-hidden p-4 md:p-6">
        <div className="flex h-full w-full items-center justify-center">
          <div
            className="shrink-0 overflow-hidden rounded-xl border border-border bg-white shadow-2xl"
      ...
      {layoutDebug ? (
        <div className="max-h-[42vh] shrink-0 overflow-auto border-t border-border bg-neutral-950/95">
              ...
              <div className="flex flex-wrap items-center gap-2 border-b border-border px-4 py-3 text-xs">
                ...
                <div className="ml-auto flex flex-wrap gap-2">
                  <button
                    ...
                    className="rounded-md border border-border px-2 py-1 text-white/80 hover:bg-white/10"
                  >
                    Copier builder
                  </button>
                  <button
                ...
                <div className="rounded-lg border border-border bg-white/5 p-3">
                  ...
                  <div className="mt-3 space-y-2 text-[11px]">
                    {blockDiffs.length === 0 ? (
                      ...
                      <div key={diff.blockId} className="rounded-md border border-border bg-black/20 p-2">
