  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto text-xs">
      ...
      <div className="px-3 py-3 border-b border-border">
        <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground mb-2">Format</p>
        <div className="space-y-2">
          <label className="flex flex-col gap-0.5">
            <span className="text-muted-foreground">Format du canvas</span>
            <select
          ...
          {template.canvas.format === "CUSTOM" && (
            <div className="flex items-center gap-2">
              <label className="flex flex-col gap-0.5 flex-1">
                <span className="text-muted-foreground text-[10px]">Largeur (px)</span>
                <input
                  type="number"
                  min={1}
              ...
              <label className="flex flex-col gap-0.5 flex-1">
                <span className="text-muted-foreground text-[10px]">Hauteur (px)</span>
                <input
                  type="number"
                  min={1}
      ...
      {/* Canvas */}
      <div className="px-3 py-3 border-b border-border">
        <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground mb-2">Canvas</p>
        <div className="space-y-2">
          <label className="flex flex-col gap-0.5">
            <span className="text-muted-foreground">Couleur de fond</span>
            <div className="flex items-center gap-2">
              <input
                type="color"
          ...
          <label className="flex flex-col gap-0.5">
            <span className="text-muted-foreground">Fond perdu (bleed, px)</span>
            <input
              type="number"
              min={0}
          ...
          <label className="flex flex-col gap-0.5">
            <span className="text-muted-foreground">Durée fixe (s)</span>
            <input
              type="number"
              min={0.5}
              step={0.5}
              ...
              className="border border-border rounded px-2 py-1 text-xs"
            />
            <span className="text-[10px] text-muted-foreground">Trim/pad la vidéo finale à cette durée. Vide = somme des slots.</span>
          </label>
        </div>
      </div>

      {/* Note de redirection vers les onglets dédiés du rail gauche */}
      <div className="px-3 py-3 border-b border-border bg-info-50/40">
        <p className="text-[11px] text-info-700 leading-relaxed">
      ...
      <div className="px-3 py-3">
        <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground mb-2">Marges (px)</p>
