          ...
          return (
            <div key={`${rule.when.field}-${index}`} className="rounded-xl border border-gray-200 bg-gray-50 p-3 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                {supportsOpacity && (
                  <label className="flex flex-col gap-1">
                    <span className="text-xs font-medium text-gray-600">Opacité</span>
                    <input
                      type="number"
                      min={0}
                      max={1}
                  ...
                  {supportsTextColor && (
                    <label className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        className="h-9 w-full border border-gray-200 rounded-lg bg-white cursor-pointer"
                      />
                    </label>
                  )}
                  {supportsBackgroundColor && (
                    <label className="flex flex-col gap-1">
                      <span className="text-xs font-medium text-gray-600">Couleur de fond</span>
                      <input
                        type="color"
