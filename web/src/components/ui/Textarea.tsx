...
export function Textarea({ value, onChange, error, variant = "default", className, disabled, ...rest }: TextareaProps) {
  ...
  const stateClass = error
    ...
    : variant === "glass"
      ...
      : "hover:shadow-[inset_0_1px_0_rgba(255,255,255,1),inset_0_0_0_1px_rgba(15,23,42,0.22),inset_0_-1px_0_rgba(15,23,42,0.08),0_1px_2px_rgba(15,23,42,0.06)] focus:shadow-[inset_0_1px_0_rgba(255,255,255,1),inset_0_0_0_1px_rgba(15,23,42,0.28),inset_0_-1px_0_rgba(15,23,42,0.08),0_0_0_3px_rgba(10,10,10,0.14)]";
